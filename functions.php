...
//Custom Logo 
function neuron_custom_logo_setup() {
    $defaults = array(
    'height'      => 100,
    'width'       => 400,
    'flex-height' => true,
   ...
   add_action( 'after_setup_theme', 'neuron_custom_logo_setup' );
...
function neuron_Wordcount_heading( $heading ) {
    $heading = "Total words";
    return $heading;
}

add_filter( "Wordcount_heading", "neuron_Wordcount_heading" );

function neuron_wordcount_tag( $tag ) {
    $tag = "h4";
    return $tag;
}
add_filter( "wordcount_tag", "neuron_wordcount_tag" );

function neuron_intro_before_title_change( $intro_title1, $intro_title2, $intro_title3 ) {
    $intro_title3 = "Dhaka Bangladesh";
    return ucwords( $intro_title1 ) . " " . strtoupper( $intro_title2 ) . " " . $intro_title3;
}
add_filter( "neuron_intro_before_title", "neuron_intro_before_title_change", 10, 3 );

function neuron_excluded_qucode_post_type($post_type){
$post_type[]="page";
$post_type[]="slider";
$post_type[]="feature";
$post_type[]="service";
...
add_filter("pqrc_excluded_post_type", "neuron_excluded_qucode_post_type");

function neuron_qrcode_dimension($dimension){
    return "100px*100px";
}
//add_filter("pqrc_qrcode_dimension", "neuron_qrcode_dimension");
