 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme neuron for publication on ThemeForest
...
add_action( 'tgmpa_register', 'neuron_register_required_plugins' );
 ...
 */
function neuron_register_required_plugins() {
    /*
